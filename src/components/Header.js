...
export default function Header({handlePrint}) {
  ...
  return (
    <header className="flex flex-col items-start justify-start mb-5 xl:flex-row xl:justify-between">
        <div>
        ...
        <ul className="flex items-center justify-between flex-wrap">
            ...
            <button className="bg-gray-500 text-white font-bold
               py-1 px-8 rounded shadow border-2 border-gray-500
            ...
            <button className="bg-blue-500 text-white font-bold
               ...
               duration-300">Download</button>
            </li>
            <li>
            <button className="bg-green-500 text-white font-bold
               py-1 px-8 rounded shadow border-2 border-green-500
               hover:bg-transparent hover:text-green-500 transition-all
